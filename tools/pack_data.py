...
datasets = {
    'dummy_dataset': {
        'data_path': '/share/tianyang/data/ChartQA',
        'annotation_path': '/share/tianyang/data/ChartQA/train_multi_turn_valid.json'
    }
}

data_args = DataArguments()
model_path = '/share/tianyang/huggingface_model/Qwen/Qwen2.5-VL-3B-Instruct'
